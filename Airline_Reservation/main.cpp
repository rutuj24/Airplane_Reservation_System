    ...
    public:
        ...
        void sort_by_date()
        {
            ...
            gotoxy(45,3); cout<<"------------------------------"<<endl;
            gotoxy(0,5); cout<<"-----------------------------------------------------------------------------------------------------------------------"<<endl;
            gotoxy(10,7); cout<<"1) 1 / 12 / 2017 "<<endl;
            gotoxy(10,9); cout<<"2) 2 / 12 / 2017 "<<endl;
            gotoxy(10,11); cout<<"3) 3 / 12 / 2017 "<<endl;
    ...
    public:
        void front_menu()
        {
            ...
            gotoxy(45,3); cout<<"------------------------------"<<endl;
            gotoxy(0,5); cout<<"-----------------------------------------------------------------------------------------------------------------------"<<endl;
            gotoxy(10,7); cout<<"1) Customer Registration"<<endl;
            gotoxy(10,9); cout<<"2) Customer Login"<<endl;
            gotoxy(10,11); cout<<"3) Admin Login"<<endl;
            gotoxy(0,13); cout<<"-----------------------------------------------------------------------------------------------------------------------"<<endl;
